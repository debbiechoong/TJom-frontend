...
class ScriptGenerationSuccess extends StatefulWidget {
  const ScriptGenerationSuccess({super.key});

  @override
  State<ScriptGenerationSuccess> createState() => _ScriptGenerationSuccessState();
}

class _ScriptGenerationSuccessState extends State<ScriptGenerationSuccess> with SingleTickerProviderStateMixin {
